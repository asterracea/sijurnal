...
<body class="flex bg-white min-h-screen">
    <aside class="hidden sm:flex sm:flex-col">
        <a href="#" class="inline-flex items-center justify-center h-20 w-32">
            <span class="h-20 w-20 bg-white overflow-hidden flex items-center justify-center">
                <img src="build/assets/logo_gamaliel.png" alt="user profile photo" class="w-full object-cover">
            </span>
        </a>

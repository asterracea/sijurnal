...
class JadwalKelas11Controller extends Controller
{
    ...
    public function index()
    {
        ...
        $jadwal = Jadwal::with(['guru', 'tahun', 'kelas', 'mapel'])
                        ->whereHas('kelas', function ($query) {
                            $query->where('nama_kelas', 'like', '11%');
                        })
                        ->get();
        ...
        // Kirim data ke view
        return view('admin.jadwalkelas12', compact('gurus', 'tahun', 'kelas', 'mapel', 'jadwal','accountname'));
    }
    ...
    public function store(Request $request)
{
    ...
    return redirect()->route('jadwalkelas11')->with('success', 'Jadwal berhasil ditambahkan!');
}
}
